...
//         imgSrc: 'https://upload.wikimedia.org/wikipedia/commons/0/0f/Ada_Lovelace_portrait.jpg',
...
//       this.setState(prev => ({ timeSinceShow: prev.timeSinceShow + 1 }));
//     }, 1000);
//   };
...
//   render() {
//     const { person, show, timeSinceShow } = this.state;
